...
Apply migrations through `202607141462_party_session_release_readiness_v2.sql`.
...
2. Enable reconciliation workers and verify conversation projection convergence
   plus `player.blocked.v2` revocation within five seconds.
