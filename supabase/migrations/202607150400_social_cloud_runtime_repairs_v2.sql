-- Social V2 PostgreSQL cloud runtime repairs.
-- Forward-only and limited to Senior 1 relationship/safety authority.
-- Proven on the dedicated Supabase PostgreSQL 17 project before merge.


alter table public.friendship_requests_v2
