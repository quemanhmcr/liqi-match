    ...
    <View style={styles.root}>
      ...
      <SafeAreaView style={styles.safe}>
        <View style={styles.card}>
          ...
          <Text style={styles.subtitle}>Bạn đã hoàn tất hồ sơ ghép đội. Trang chính sẽ dùng dữ liệu đã lưu để hiển thị đề xuất đồng đội, match và chat.</Text>
        </View>
      </SafeAreaView>
    </View>
  );
...
const styles = StyleSheet.create({
  ...
  card: { backgroundColor: 'rgba(13,17,34,0.9)', borderRadius: 28, gap: 14, padding: 22 },
  eyebrow: { color: '#C679FF', fontSize: 12, fontWeight: '900', letterSpacing: 1.2 },
