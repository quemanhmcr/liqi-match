...
/**
 * Home-authoritative visual foundation for product UI.
 *
 * This module contains only cross-feature semantics. Screen-specific recipes belong
 * to their owning feature and must not be added here.
 */
export const appUiVersion = '1.0.0' as const;
