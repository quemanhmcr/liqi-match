...
function main() {
  ...
  console.log(
    `TRUST_RETURN_LOOP_CLOUD_DB_TARGET target=${E2E_DISPOSABLE_PROJECT.target} project_name=${E2E_DISPOSABLE_PROJECT.projectName} project_ref=${linkedProjectRef} cli=${SUPABASE_CLI}`,
  );
